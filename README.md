...
- What is the runtime complexity to access an array, add or remove from the front, and add or remove from the back?
  ...
  - access an array: O(1)
  - add/remove from the front/middle: O(n)
  - add/remove from the back: O(1)
...
Explain how a blockchain is structured. What are the blocks, what is the chain? How is the data organized?
    ...
    - A block is a record essentially
    - the chain is a list of records, and how the blocks are organized. Organized in order of blocks mined.

Explain how proof of work functions. How does it operate. How does this protect the chain from attack. What kind of attack is possible?

    - it's a piece of data that is meant to be arbitrarily difficult to produce (brute-force) and is pretty much random
    - the difficulty can be adjusted
    - defends from DoS attacks because it takes a long time to compute
